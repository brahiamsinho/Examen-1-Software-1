...
| A repeatable multi-step workflow          | New skill in `.agents/skills/` o `.github/skills/`                 |
| A persistent constraint or convention     | New instruction in `.github/instructions/`                         |
